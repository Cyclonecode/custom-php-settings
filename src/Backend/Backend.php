...
class Backend extends Singleton
{
    ...
    public function addProNotice()
    {
        ...
        <p><?php echo sprintf(__('The Pro version only costs 15 EUR annually, or you can buy me 3 beers at <a href="%s" target="_blank" rel="noopener noreferrer">%s</a>', self::TEXT_DOMAIN), 'https://www.buymeacoffee.com/cyclonecode', 'buymeacoffee'); ?>.</p>
